...
SELECT
    ...
    -- [MỚI] 2. Kéo các cột phục vụ tính toán chu kỳ vào bảng Fact
    cal.trading_day_seq,
    cal.is_trading_day,
...
-- [MỚI] 3. Nối với bảng Lịch thông qua Ngày
LEFT JOIN dim_cal cal 
    ON DATE(d.time) = cal.trading_date
-- [MỚI] 4. (Tùy chọn cực kỳ khuyên dùng) Lọc sạch các giao dịch lỗi/test rơi vào ngày nghỉ
